...
```
{% asset_img 在Markdown中嵌入UML文档_01.png %}
...
```
{% asset_img 在Markdown中嵌入UML文档_02.png %}
...
```
{% asset_img 在Markdown中嵌入UML文档_03.png %}
...
```
{% asset_img 在Markdown中嵌入UML文档_04.png %}
...
```
{% asset_img 在Markdown中嵌入UML文档_05.png %}
...
```
{% asset_img 在Markdown中嵌入UML文档_06.png %}
